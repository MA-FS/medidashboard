...
@callback(
    Output("view-readings-modal", "is_open"),
    ...
    State("view-readings-modal", "is_open"),
...
@callback(
    Output("delete-reading-confirm-modal", "is_open"),
    ...
    State("delete-reading-confirm-modal", "is_open"),
    prevent_initial_call=True
)
